...
define( 'YOURLS_DB_USER', 'letterbo_raffsun' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', 'tini_@m@*_*0b' );

/** The name of the database for YOURLS
 ** Use lower case letters [a-z], digits [0-9] and underscores [_] only */
define( 'YOURLS_DB_NAME', 'letterbo_url' );
...
define( 'YOURLS_SITE', 'http://letter-box.xyz/url' );
...
define( 'YOURLS_COOKIEKEY', 'abcdWXYZHiJ9546' );

/** Username(s) and password(s) allowed to access the site. Passwords either in plain text or as encrypted hashes
 ** YOURLS will auto encrypt plain text passwords in this file
 ** Read http://yourls.org/userpassword for more information */
$yourls_user_passwords = [
	'username' => 'phpass:!2y!10!YWG3BP19eFE8nhdewzRXBefPdg1.SjQmwgfDw9N5G9s7A1WbZ5nlK' /* Password encrypted by YOURLS */ ,
	'admin' => 'phpass:!2y!10!IEcyFd81ekfOw/6JrAC9wOn5FIAPFh.i1hmtMbOuc8UcZFV/gJday' /* Password encrypted by YOURLS */ ,
...
define('YOURLS_API_KEY', 'hello123');  // You can change 'hello123' to any simple password


$yourls_user_passwords = [
	'admin' => 'phpass:!2y!10!m7SZeF9bFr.0uLGC.hjunOWfVwazs.qpK1erH1r2h.kRMtMzr8pNy' /* Password encrypted by YOURLS */ ,
];
